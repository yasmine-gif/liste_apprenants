...
<header id="header" class="fixed-top">
 ...
 <form action="/tuteurs" method="POST" class="formulaire" enctype="multipart/form-data">
 <div class="formulaire-parent">
   ...
   <div class="row champ">
   <div class="col ">
  <input type="text" class="form-control" placeholder="NOM" name="nomTuteur" required >
  </div>
  <div class="col">
  <input type="text" class="form-control" placeholder="PROFESSION" name="profession" required >
   ...
   <div class="row champ">
     <div class="col">
    <input type="text" class="form-control" placeholder="PRENOM" name="prenomTuteur" required >
    </div>
    <div class="col">
    <input type="text" class="form-control" placeholder="TELEPHONE" name="telephoneTuteur" required >
    </div>
    </div>
